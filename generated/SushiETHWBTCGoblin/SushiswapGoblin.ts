...
export class SushiswapGoblin extends ethereum.SmartContract {
  static bind(address: Address): SushiswapGoblin {
    return new SushiswapGoblin("SushiswapGoblin", address);
  }
