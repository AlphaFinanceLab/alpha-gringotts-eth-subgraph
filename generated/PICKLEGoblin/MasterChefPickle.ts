...
export class MasterChefPickle__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MasterChefPickle__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class MasterChefPickle extends ethereum.SmartContract {
  static bind(address: Address): MasterChefPickle {
    return new MasterChefPickle("MasterChefPickle", address);
  }
  ...
  poolInfo(param0: BigInt): MasterChefPickle__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new MasterChefPickle__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<MasterChefPickle__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new MasterChefPickle__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  userInfo(param0: BigInt, param1: Address): MasterChefPickle__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new MasterChefPickle__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<MasterChefPickle__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MasterChefPickle__userInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
