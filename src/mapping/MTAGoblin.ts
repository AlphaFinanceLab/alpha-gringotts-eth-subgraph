...
import { MStableGoblin, Reinvest, AddShare, RemoveShare, Liquidate } from "../../generated/MTAGoblin/MStableGoblin";
import { MStableStakingRewards } from "../../generated/MTAGoblin/MStableStakingRewards";
...
function updateGoblinSummary(goblinAddress: Address): void {
  ...
  let goblin = MStableGoblin.bind(goblinAddress);
  let staking = MStableStakingRewards.bind(goblin.staking());
