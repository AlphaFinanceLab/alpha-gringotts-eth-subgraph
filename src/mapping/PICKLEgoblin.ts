...
import {
  ...
  RemoveShare,
  Liquidate,
} from "../../generated/PICKLEGoblin/SushiswapGoblin";
import { MasterChefPickle } from "../../generated/PICKLEGoblin/MasterChefPickle";
...
function updateGoblinSummary(goblinAddress: Address): void {
  ...
  let masterChef = MasterChefPickle.bind(goblin.masterChef());
